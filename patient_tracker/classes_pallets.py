...
GOLIATH_SKELETON_INFO = {
    0: dict(link=(13, 11), id=0, color=[0, 255, 0]),
    1: dict(link=(11, 9), id=1, color=[0, 255, 0]),
    2: dict(link=(14, 12), id=2, color=[255, 128, 0]),
    3: dict(link=(12, 10), id=3, color=[255, 128, 0]),
    4: dict(link=(9, 10), id=4, color=[51, 153, 255]),
    5: dict(link=(5, 9), id=5, color=[51, 153, 255]),
    6: dict(link=(6, 10), id=6, color=[51, 153, 255]),
    7: dict(link=(5, 6), id=7, color=[51, 153, 255]),
    8: dict(link=(5, 7), id=8, color=[0, 255, 0]),
    9: dict(link=(6, 8), id=9, color=[255, 128, 0]),
    10: dict(link=(7, 62), id=10, color=[0, 255, 0]),
    11: dict(link=(8, 41), id=11, color=[255, 128, 0]),
    ...
    19: dict(link=(13, 15), id=19, color=[0, 255, 0]),
    20: dict(link=(13, 16), id=20, color=[0, 255, 0]),
    21: dict(link=(13, 17), id=21, color=[0, 255, 0]),
    22: dict(link=(14, 18), id=22, color=[255, 128, 0]),
    23: dict(link=(14, 19), id=23, color=[255, 128, 0]),
    24: dict(link=(14, 20), id=24, color=[255, 128, 0]),
    25: dict(link=(62, 45), id=25, color=[255, 128, 0]),
    26: dict(link=(45, 44), id=26, color=[255, 128, 0]),
    27: dict(link=(44, 43), id=27, color=[255, 128, 0]),
    28: dict(link=(43, 42), id=28, color=[255, 128, 0]),
    29: dict(link=(62, 49), id=29, color=[255, 153, 255]),
    30: dict(link=(49, 48), id=30, color=[255, 153, 255]),
    31: dict(link=(48, 47), id=31, color=[255, 153, 255]),
    32: dict(link=(47, 46), id=32, color=[255, 153, 255]),
    33: dict(link=(62, 53), id=33, color=[102, 178, 255]),
    34: dict(link=(53, 52), id=34, color=[102, 178, 255]),
    35: dict(link=(52, 51), id=35, color=[102, 178, 255]),
    36: dict(link=(51, 50), id=36, color=[102, 178, 255]),
    37: dict(link=(62, 57), id=37, color=[255, 51, 51]),
    38: dict(link=(57, 56), id=38, color=[255, 51, 51]),
    39: dict(link=(56, 55), id=39, color=[255, 51, 51]),
    40: dict(link=(55, 54), id=40, color=[255, 51, 51]),
    41: dict(link=(62, 61), id=41, color=[0, 255, 0]),
    42: dict(link=(61, 60), id=42, color=[0, 255, 0]),
    43: dict(link=(60, 59), id=43, color=[0, 255, 0]),
    44: dict(link=(59, 58), id=44, color=[0, 255, 0]),
    45: dict(link=(41, 24), id=45, color=[255, 128, 0]),
    46: dict(link=(24, 23), id=46, color=[255, 128, 0]),
    47: dict(link=(23, 22), id=47, color=[255, 128, 0]),
    48: dict(link=(22, 21), id=48, color=[255, 128, 0]),
    49: dict(link=(41, 28), id=49, color=[255, 153, 255]),
    50: dict(link=(28, 27), id=50, color=[255, 153, 255]),
    51: dict(link=(27, 26), id=51, color=[255, 153, 255]),
    52: dict(link=(26, 25), id=52, color=[255, 153, 255]),
    53: dict(link=(41, 32), id=53, color=[102, 178, 255]),
    54: dict(link=(32, 31), id=54, color=[102, 178, 255]),
    55: dict(link=(31, 30), id=55, color=[102, 178, 255]),
    56: dict(link=(30, 29), id=56, color=[102, 178, 255]),
    57: dict(link=(41, 36), id=57, color=[255, 51, 51]),
    58: dict(link=(36, 35), id=58, color=[255, 51, 51]),
    59: dict(link=(35, 34), id=59, color=[255, 51, 51]),
    60: dict(link=(34, 33), id=60, color=[255, 51, 51]),
    61: dict(link=(41, 40), id=61, color=[0, 255, 0]),
    62: dict(link=(40, 39), id=62, color=[0, 255, 0]),
    63: dict(link=(39, 38), id=63, color=[0, 255, 0]),
    64: dict(link=(38, 37), id=64, color=[0, 255, 0])
}
